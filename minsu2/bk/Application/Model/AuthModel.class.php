...
class AuthModel extends Model{
    ...
    function saveData($data){
        ...
        $sql = "update bk_auth set auth_path='$path',auth_sort='$sort',auth_c='$c',auth_a='$a',auth_level='$level',auth_add='$add',auth_edit='$edit',auth_del='$del',auth_icon='$icon' where auth_id='$newid'";
