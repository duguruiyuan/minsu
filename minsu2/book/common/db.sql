...
(1, 'Administrator', 'xiexiaojing@le.com', 'admin', 'admin', 'administrator', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 1);
...
(1, 1, 'Accueil', 'Lorem ipsum dolor sit amet', 'Consectetur adipiscing elit', 'Accueil', '', '', 'index,follow', '', '', '', '', 0, 'home', '', 1, 0, 1, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(1, 2, 'Home', 'Panda Resort, Luxury Hotel', '', 'Panda Resort, web software to create and manage hotels websites', '', '', 'index,follow', '', '', '<blockquote class="text-center">\r\n<p>A man travels the world over in search of what he needs and returns home to find it.</p>\r\n</blockquote>\r\n\r\n<p class="text-muted" style="text-align: center;">- George A. Moore -</p>\r\n', '', 0, 'home', '', 1, 0, 1, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(1, 3, 'ترحيب', 'هو سقطت الساحلية ذات, أن.', 'غير بمعارضة وهولندا، الإقتصادية قد, فقد الفرنسي المعاهدات قد من.', 'ترحيب', '', '', 'index,follow', '', '', '', '', 0, 'home', '', 1, 0, 1, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(2, 1, 'Contact', 'Contact', '', 'Contact', 'contact', '', 'index,follow', '', '', '', '', 0, 'contact', '', 1, 1, 0, 1, 9, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(2, 2, 'Contact', 'Contact', '', 'Contact', 'contact', '', 'index,follow', '', '', '', '', 0, 'contact', '', 1, 1, 0, 1, 9, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(2, 3, 'جهة الاتصال', 'جهة الاتصال', '', 'جهة الاتصال', 'contact', '', 'index,follow', '', '', '', '', 0, 'contact', '', 1, 1, 0, 1, 9, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(3, 1, 'Mentions légales', 'Mentions légales', '', 'Mentions légales', 'mentions-legales', '', 'index,follow', '', '', '', '', 0, 'page', '', 0, 1, 0, 1, 10, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(3, 2, 'Legal notices', 'Legal notices', '', 'Legal notices', 'legal-notices', '', 'index,follow', '', '', '', '', 0, 'page', '', 0, 1, 0, 1, 10, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(3, 3, 'يذكر القانونية', 'يذكر القانونية', '', 'يذكر القانونية', 'legal-notices', '', 'index,follow', '', '', '', '', 0, 'page', '', 0, 1, 0, 1, 10, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(4, 1, 'Plan du site', 'Plan du site', '', 'Plan du site', 'plan-site', '', 'index,follow', '', '', '', '', 0, 'sitemap', '', 0, 1, 0, 1, 11, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(4, 2, 'Sitemap', 'Sitemap', '', 'Sitemap', 'sitemap', '', 'index,follow', '', '', '', '', 0, 'sitemap', '', 0, 1, 0, 1, 11, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(4, 3, 'خريطة الموقع', 'خريطة الموقع', '', 'خريطة الموقع', 'sitemap', '', 'index,follow', '', '', '', '', 0, 'sitemap', '', 0, 1, 0, 1, 11, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(5, 1, 'Ma première page', 'Ma première page', '', 'Ma première page', 'my-first-page', '', 'index,follow', '', '', '', '', 0, 'page', 'article', 1, 0, 0, 1, 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(5, 2, 'Hotel', 'Hotel', '', 'Hotel', 'hotel', '', 'index,follow', '', '', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque fringilla vel est at rhoncus. Cras porttitor ligula vel magna vehicula accumsan. Mauris eget elit et sem commodo interdum. Aenean dolor sem, tincidunt ac neque tempus, hendrerit blandit lacus. Vivamus placerat nulla in mi tristique, fringilla fermentum nisl vehicula. Nullam quis eros non magna tincidunt interdum ac eu eros. Morbi malesuada pulvinar ultrices. Etiam bibendum efficitur risus, sit amet venenatis urna ullamcorper non. Proin fermentum malesuada tortor, vitae mattis sem scelerisque in. Curabitur rutrum leo at mi efficitur suscipit. Vivamus tristique lorem eros, sit amet malesuada augue sodales sed.</p>\r\n', '<p>Etiam bibendum efficitur risus, sit amet venenatis urna ullamcorper non. Proin fermentum malesuada tortor, vitae mattis sem scelerisque in. Curabitur rutrum leo at mi efficitur.</p>\r\n', 0, 'page', 'article', 1, 0, 0, 1, 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(5, 3, 'صفحتي الأولى', 'صفحتي الأولى', '', 'صفحتي الأولى', 'my-first-page', '', 'index,follow', '', '', '', '', 0, 'page', 'article', 1, 0, 0, 1, 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(6, 1, 'Recherche', 'Recherche', '', 'Recherche', 'search', '', 'noindex,nofollow', '', '', '', '', 0, 'search', '', 0, 0, 0, 1, 12, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(6, 2, 'Search', 'Search', '', 'Search', 'search', '', 'noindex,nofollow', '', '', '', '', 0, 'search', '', 0, 0, 0, 1, 12, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(6, 3, 'بحث', 'بحث', '', 'بحث', 'search', '', 'noindex,nofollow', '', '', '', '', 0, 'search', '', 0, 0, 0, 1, 12, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(7, 1, 'Galerie', 'Galerie', '', 'Galerie', 'galerie', '', 'index,follow', '', '', '', '', 0, 'page', 'gallery', 1, 0, 0, 1, 4, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(7, 2, 'Gallery', 'Gallery', '', 'Gallery', 'gallery', '', 'index,follow', '', '', '', '', 0, 'page', 'gallery', 1, 0, 0, 1, 4, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(7, 3, 'صور معرض', 'صور معرض', '', 'صور معرض', 'gallery', '', 'index,follow', '', '', '', '', 0, 'page', 'gallery', 1, 0, 0, 1, 4, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(8, 1, '404', 'Erreur 404 : Page introuvable !', '', '404 Page introuvable', '404', '', 'noindex,nofollow', '', '', '<p>L''URL demandée n''a pas été trouvée sur ce serveur.<br />\r\nLa page que vous voulez afficher n''existe pas, ou est temporairement indisponible.</p>\r\n\r\n<p>Merci d''essayer les actions suivantes :</p>\r\n\r\n<ul>\r\n	<li>Assurez-vous que l''URL dans la barre d''adresse de votre navigateur est correctement orthographiée et formatée.</li>\r\n	<li>Si vous avez atteint cette page en cliquant sur un lien ou si vous pensez que cela concerne une erreur du serveur, contactez l''administrateur pour l''alerter.</li>\r\n</ul>\r\n', '', 0, '404', '', 0, 0, 0, 1, 13, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
...
(8, 3, '404', '404 Error: Page not found!', '', '404 Not Found', '404', '', 'noindex,nofollow', '', '', '', '', 0, '404', '', 0, 0, 0, 1, 13, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(9, 1, 'Chambres', 'Chambres', '', 'Chambres', 'chambres', '', 'index,follow', '', '', '', '', 0, 'rooms', 'room', 1, 0, 0, 1, 3, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(9, 2, 'Rooms', 'Rooms', '', 'Rooms', 'rooms', '', 'index,follow', '', '', '', '', 0, 'rooms', 'room', 1, 0, 0, 1, 3, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(9, 3, 'الغرف', 'الغرف', '', 'الغرف', 'rooms', '', 'index,follow', '', '', '', '', 0, 'rooms', 'room', 1, 0, 0, 1, 3, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 0),
(10, 1, 'Réserver', 'Réserver', '', 'Réserver', 'reserver', '', 'noindex,nofollow', '', '', '', '', 0, 'booking', '', 1, 0, 0, 1, 5, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(10, 2, 'Booking', 'Booking', '', 'Booking', 'booking', '', 'noindex,nofollow', '', '', '', '', 0, 'booking', '', 1, 0, 0, 1, 5, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(10, 3, 'الحجز', 'الحجز', '', 'الحجز', 'booking', '', 'noindex,nofollow', '', '', '', '', 0, 'booking', '', 1, 0, 0, 1, 5, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(11, 1, 'Coordonnées', 'Coordonnées', '', 'Coordonnées', 'coordonnees', '', 'noindex,nofollow', '', '', '', '', 10, 'details', '', 0, 0, 0, 1, 6, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(11, 2, 'Details', 'Booking details', '', 'Booking details', 'booking-details', '', 'noindex,nofollow', '', '', '', '', 10, 'details', '', 0, 0, 0, 1, 6, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(11, 3, 'تفاصيل الحجز', 'تفاصيل الحجز', '', 'تفاصيل الحجز', 'booking-details', '', 'noindex,nofollow', '', '', '', '', 10, 'details', '', 0, 0, 0, 1, 6, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(12, 1, 'Paiement', 'Paiement', '', 'Paiement', 'paiement', '', 'noindex,nofollow', '', '', '', '', 13, 'payment', '', 0, 0, 0, 1, 8, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(12, 2, 'Payment', 'Payment', '', 'Payment', 'payment', '', 'noindex,nofollow', '', '', '', '', 13, 'payment', '', 0, 0, 0, 1, 8, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(12, 3, 'دفع', 'دفع', '', 'دفع', 'payment', '', 'noindex,nofollow', '', '', '', '', 13, 'payment', '', 0, 0, 0, 1, 8, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(13, 1, 'Résumé de la réservation', 'Résumé de la réservation', '', 'Résumé de la réservation', 'resume-reservation', '', 'noindex,nofollow', '', '', '', '', 11, 'summary', '', 0, 0, 0, 1, 7, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(13, 2, 'Summary', 'Booking summary', '', 'Booking summary', 'booking-summary', '', 'noindex,nofollow', '', '', '', '', 11, 'summary', '', 0, 0, 0, 1, 7, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1),
(13, 3, 'ملخص الحجز', 'ملخص الحجز', '', 'ملخص الحجز', 'booking-summary', '', 'noindex,nofollow', '', '', '', '', 11, 'summary', '', 0, 0, 0, 1, 7, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, 1);
...
INSERT INTO pm_country  (`name`,`code`) VALUES
( 'Afghanistan', 'AF'),
( 'Åland', 'AX'),
( 'Albania', 'AL'),
( 'Algeria', 'DZ'),
